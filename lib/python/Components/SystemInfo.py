...
SystemInfo["canMode12"] = SystemInfo["canMultiBoot"] and '200M' if HardwareInfo().get_device_model() == "h7" else SystemInfo["canMultiBoot"] and '192M' if HardwareInfo().get_device_model() == ('hd51', vs1500')
