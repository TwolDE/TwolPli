...
SystemInfo["canMultiBoot"] = HardwareInfo().get_device_model() in ('hd51', 'h7', 'vs1500', 'gbue4k', 'gbquad4k', 'e4hd')
SystemInfo["canMultiBootHD"] = HardwareInfo().get_device_model() in ('hd51', 'h7', 'vs1500', 'e4hd')
